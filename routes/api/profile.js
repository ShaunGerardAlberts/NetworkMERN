...
router.post(
  ...
  (req, res) => {
    ...
    // Social
    profileFields.social = {}; // must initialse it as an object cause social is in an object, 
    // so if we dont, itll throw an error saying that profileFields.social doesnt exist
      ...
      .then(profile => {
        if (profile) {
          ...
          Profile.findOneAndUpdate(
            ...
            .catch(err => res.json({ error: "cant update" }))
        } else {
          // Create
